                    ...
                    <fo:table-row>
                        <fo:table-cell column-number="1" display-align="after">
                            <fo:block break-before="auto" keep-together.within-page="always">
                                ...
                                SHIP TO:
                                                ...
                                                <fo:block font-size="8pt" font-family="Verdana">
                                                    Job#: <xsl:value-of select="Invoice/Detail/Rental_Agreement_Info/Ship_To/Job" />
                                                <xsl:value-of select="'&#x2028;'" />
                                                ...
                                                <xsl:value-of select="'&#x2028;'" />
                                                PH: <xsl:value-of select="Invoice/Detail/Rental_Agreement_Info/Ship_To/Phone" />
                                            <xsl:value-of select="'&#x2028;'" />
                                        </fo:block>
                                    </fo:table-cell>
                                ...
                                RENTED FROM:
                                        ...
                                        <xsl:value-of select="'&#x2028;'" />
                                            Sales Rep: <xsl:value-of select="Invoice/Detail/Rental_Agreement_Info/Rented_From/SalesRep" />
                                    <xsl:value-of select="'&#x2028;'" />
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell column-number="3" text-align="left">
                                <fo:block>
                                    <fo:table table-layout="fixed" width="100%">
                                        <fo:table-column column-width="28%" border="1pt solid black"/>
                                        <fo:table-column column-width="24%" border="1pt solid black"/>
                                        <fo:table-column column-width="24%" border="1pt solid black"/>
                                        <fo:table-column column-width="24%" border="1pt solid black"/>
                                        <fo:table-body>
                                            <fo:table-row font-size="8pt">
                                            ...
                                            <fo:table-row font-size="8pt">
                                                ...
                                                <fo:table-cell column-number="2" text-align="right">
                                                    <fo:block font-size="8pt" font-family="Verdana">
                                                        <xsl:value-of select="Invoice/Detail/Rental_Agreement_Info/SalesItems/Original" />
                                                    </fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell column-number="3" text-align="right">
                                                    <fo:block font-size="8pt" font-family="Verdana">
                                                        <fo:block font-size="8pt" font-family="Verdana">
                                                            <xsl:value-of select="Invoice/Detail/Rental_Agreement_Info/SalesItems/Adjustment" />
                                                        </fo:block>
                                                    </fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell column-number="4" text-align="right">
                                                    <fo:block font-size="8pt" font-family="Verdana">
                                                        <fo:block font-size="8pt" font-family="Verdana">
                                                            <xsl:value-of select="Invoice/Detail/Rental_Agreement_Info/SalesItems/Total" />
                                                        </fo:block>
                                                    </fo:block>
                                                </fo:table-cell>
                                            </fo:table-row>
