...
<xsl:stylesheet version="1.0"
	...
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/address.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/addressFirstPage.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/headerNotes.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/hyphenateSerial.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/invoiceDetails.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/invoiceDetailsFirstPage.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/orderDetails.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/orderDetailsHeader.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/orderDetailsHeaderFirstPage.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/footer.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/blockWithBlank.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/paymentNote.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/paymentHistory.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/shippingAndCharges.xsl"/>
	<xsl:include href="fop_template_v3/us_sales_invoice/templateFiles/newLineForBlank.xsl"/>
		...
		<fo:root
			...
			<fo:layout-master-set>
				...
				<fo:simple-page-master master-name="contentFirstPage" page-width="210mm" page-height="297mm" margin-top="10mm" margin-bottom="8mm" margin-left="5mm" margin-right="5mm">
					<fo:region-body margin-bottom="25mm" margin-top="104mm" border="1px solid black" />
