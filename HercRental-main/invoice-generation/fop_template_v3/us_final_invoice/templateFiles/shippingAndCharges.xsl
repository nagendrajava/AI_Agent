                                                                        ...
                                                                        <fo:table-body>
                                                                            <fo:table-row font-size="8pt">
                                                                                ...
                                                                                <fo:table-cell column-number="3" text-align="left">
                                                                                    <fo:block font-size="8pt" font-family="Verdana">
                                                                                        <xsl:value-of select="concat(Invoice/Detail/Rental_Agreement_Info/Rental_Details/Days,' / ',Invoice/Detail/Rental_Agreement_Info/Rental_Details/Hours)" />
                                                                                    </fo:block>
                                                                                </fo:table-cell>
                                                                            </fo:table-row>
                                                                            <fo:table-row font-size="8pt">
                                                                                ...
                                                                                <fo:table-cell column-number="3" text-align="left">
                                                                                    <fo:block font-size="8pt" font-family="Verdana">
                                                                                        <xsl:value-of select="Invoice/Detail/Rental_Agreement_Info/Rental_Details/InvoiceFromTime" />
                                                                                    </fo:block>
                                                                                </fo:table-cell>
                                                                            </fo:table-row>
                                                                            <fo:table-row font-size="8pt">
                                                                                ...
                                                                                <fo:table-cell column-number="3" text-align="left">
                                                                                    <fo:block font-size="8pt" font-family="Verdana">
                                                                                        <xsl:value-of select="Invoice/Detail/Rental_Agreement_Info/Rental_Details/InvoiceToTime" />
                                                                                    </fo:block>
                                                                                </fo:table-cell>
                                                                            </fo:table-row>
                                                                        </fo:table-body>
