                ...
                <fo:table-body>
                    <fo:table-row>
                        ...
                        <fo:table-cell column-number="2">
                            <fo:block text-align="left" font-size="8pt">
                                <fo:block>RES/QUOTE #: <xsl:value-of
                    ...
                    <xsl:if test="$is-last-page = true()">
                        <fo:table-row>
                            <fo:table-cell number-columns-spanned="3">
                                <fo:table table-layout="fixed" width="100%">
                                    ...
                                    <fo:table-body>
                                        ...
                                        <fo:table-row>
                                            <fo:table-cell padding-left="10pt" number-columns-spanned="4">
                                                <fo:block font-weight="bold" text-align="left" font-size="8pt">Carefully read the terms and conditions on reverse side of this page
                                                </fo:block>
                                            </fo:table-cell>
                                        </fo:table-row>
                                    </fo:table-body>
                            ...
                            <fo:table-cell display-align="center" column-number="4">
                                <fo:block text-align="right" font-size="8pt"> Page <fo:page-number /> of <fo:page-number-citation
                                        ref-id="last-page" />
                                </fo:block>
                            </fo:table-cell>
                        </fo:table-row>
