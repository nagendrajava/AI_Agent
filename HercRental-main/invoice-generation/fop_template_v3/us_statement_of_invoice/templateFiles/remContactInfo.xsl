                                                            ...
                                                            <fo:table-row >
                                                                <fo:table-cell column-number="1" text-align="center" font-size="9pt" border-top="1px solid black">
                                                                    <fo:block>
                                                                        <xsl:value-of select="'&#x2028;'" />
                                                                        <xsl:value-of select="'&#x2028;'" />
                                                                        <fo:external-graphic content-width="100%" content-height="100%" src="url(fop_template_v3/logos/proControlBlackLogo.png)"/>
                                                                        <xsl:value-of select="'&#x2028;'" />
                                                                        www.hercrentals.com
                                                                    </fo:block>
                                                                </fo:table-cell>
                                                        ...
                                                        <fo:table-body >
                                                            <fo:table-row >
                                                                ...
                                                                <fo:table-cell column-number="2" text-align="left" font-weight="bold" font-size="11pt">
                                                                    <fo:block>
                                                                        <fo:external-graphic content-width="80%" content-height="80%" src="url(fop_template_v3/logos/paperlessLogo.png)"/>
                                                                    </fo:block>
                                                                </fo:table-cell>
                                                            </fo:table-row>
                                                        </fo:table-body>
