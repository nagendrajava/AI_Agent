                ...
                <fo:table-body>
                    <fo:table-row border-bottom="2pt solid black">
                        <fo:table-cell column-number="1">
                            <fo:block font-weight="bold" font-size="8pt" text-align="center">Invoice #</fo:block>
                        </fo:table-cell>
                        <fo:table-cell column-number="2">
                            <fo:block font-weight="bold" font-size="8pt" text-align="center">Inv. Date</fo:block>
                        </fo:table-cell>
                        <fo:table-cell column-number="3">
                            <fo:block font-weight="bold" font-size="8pt" text-align="center">PO #</fo:block>
                        </fo:table-cell>
                        <fo:table-cell column-number="4">
                            <fo:block font-weight="bold" font-size="8pt" text-align="center">Job Location</fo:block>
                        </fo:table-cell>
                        <fo:table-cell column-number="5">
                            <fo:block font-weight="bold" font-size="8pt" text-align="center">Invoice Amount</fo:block>
                        </fo:table-cell>
                        <fo:table-cell column-number="6">
                            <fo:block font-weight="bold" font-size="8pt" text-align="center">Balance</fo:block>
                        </fo:table-cell>
