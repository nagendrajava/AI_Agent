...
<xsl:stylesheet version="1.0"
    ...
    <!-- <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/address.xsl"/> -->
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/addressFirstPage.xsl"/>
    <!-- <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/headerNotes.xsl"/> -->
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/hyphenateSerial.xsl"/>
    <!-- <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/invoiceDetails.xsl"/> -->
    <!-- <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/invoiceDetailsFirstPage.xsl"/> -->
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/orderDetails.xsl"/>
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/orderDetailsHeader.xsl"/>
    <!-- <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/orderDetailsHeaderFirstPage.xsl"/> -->
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/footer.xsl"/>
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/blockWithBlank.xsl"/>
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/paymentNote.xsl"/>
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/agingDetails.xsl"/>
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/newLineForBlank.xsl"/>
    <xsl:include href="fop_template_v3/us_statement_of_invoice/templateFiles/remContactInfo.xsl"/>
